...
const Optimization = ({ placement = 'bottom' }: OptimizationProps) => {
        ...
        <>
          ...
          <AnimatePresence>
            {open && (
              <PopoverPanel
                className={cn(
                  'absolute z-50 w-64 md:w-[250px] left-0',
              ...
              >
                <motion.div
                  ...
                  className={cn(
                    'flex flex-col space-y-2 bg-light-primary dark:bg-dark-primary border rounded-xl border-light-200 dark:border-dark-200 w-full p-2 max-h-[260px] md:max-h-none overflow-y-auto shadow-2xl',
