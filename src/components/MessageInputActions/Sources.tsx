...
const Sources = ({ placement = 'bottom' }: SourcesProps) => {
          ...
          <AnimatePresence>
            {open && (
              <PopoverPanel
                static
                className={cn(
                  'absolute z-50 w-64 md:w-[225px] right-0',
              ...
              >
                <motion.div
                  ...
                  className={cn(
                    'flex flex-col bg-light-primary dark:bg-dark-primary border rounded-xl border-light-200 dark:border-dark-200 w-full p-1 max-h-[240px] md:max-h-none overflow-y-auto shadow-2xl',
