...
export const PREDEFINED_PROVIDERS: PredefinedProviderDef[] = [
  ...
  {
    key: '9router',
    name: '9Router (Local AI Gateway)',
    color: '#6366f1',
    baseUrl: 'http://localhost:20128/v1',
    docsUrl: 'https://github.com/decolua/9router',
    apiKeyPlaceholder: 'Not needed (Local)',
    defaultChatModels: [
      { key: 'kr/claude-sonnet-4.5', name: 'Claude 3.7 / 4.5 Sonnet (via Kiro / 9Router)' },
      { key: 'kr/gpt-5.6-sol-agentic', name: 'GPT-5.6 Sol (via Kiro / 9Router)' },
      { key: 'cf/@cf/meta/llama-3.3-70b-instruct-fp8-fast', name: 'Llama 3.3 70B (Fast FP8)' },
      { key: 'openrouter/openrouter/free', name: 'OpenRouter Free Model' },
      { key: 'deepseek-ai/DeepSeek-V3', name: 'DeepSeek V3' },
    ],
    defaultEmbeddingModels: [],
    description: 'Local AI router & token saver. Connects 40+ providers via localhost:20128 with auto-fallback and RTK.',
  },
  {
    key: 'custom',
